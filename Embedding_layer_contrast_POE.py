...
train_test_rate = 0.7
decay_rate = 0.8
model_name = "FinetuneBertMFANMLP"
#############################################################################

##############################
selected_model = FinetuneBertMFANMLP
##########################
...
def train(rank, world_size, data, logger):
    ...
    model = selected_model(vocab_size, y_dim, z_dim, embedding_dim).cuda(rank)
