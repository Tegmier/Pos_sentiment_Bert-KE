...
from utils.contrast_poe_dataloader_no_mask import contrast_poe_dataloader_no_mask,batch_padding
...
def train(rank, world_size, data, logger):
    ...
    dataset = contrast_poe_dataloader_no_mask(data=data)
...
def eval(data, logger):
    ...
    # 创建数据集和采样器
    testdata = contrast_poe_dataloader_no_mask(data)
