...
from model.model_MFAN_bilstm import FinetuneBertMFANbilstm, bert_model
...
def train(rank, world_size, data, logger):
    ...
    # 初始化模型
    model = FinetuneBertMFANbilstm(bert_model=bert_model, y_dim=y_dim, z_dim=z_dim, embedding_dim=embedding_dim).cuda(rank)
